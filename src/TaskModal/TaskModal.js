        ...
        <Modal.Body>
          <form>
            ...
            <div className='modal-label-and-input'>
              <label for="title" className='modal-label'>Title</label>
              <input 
                type="text" 
                name="title" 
                id="title" 
            ...
            {/* Status */}
            <div className='modal-label-and-input'>
              <label for="status" className='modal-label'>Status</label>
              <Select 
                className='modal-input-full-width'
                value={statuses.value}
                options={statuses}
                defaultValue={statuses.filter((status) => status.value == editedTask.status)}
                name="status"
            ...
            <div className='modal-label-and-input'>
              ...
              />
              <label for='allDay' style={{ 'margin-left': '5px' }}>All day event</label>
            </div>

            {/* Start date/time */}
            <div>{editedTask.start}</div>
            <div className='modal-label-and-input'>
              <label for="start" className='modal-label'>Start date</label>
              {props.mode == "new" ? 
                <input 
                  type="date" 
                  id="date-start" 
            ...
            {/* End date/time */}
            <div className='modal-label-and-input'>
              <label for="due" className='modal-label'>Due date</label>
              <input 
                type="date" 
                name="dueDate" 
            ...
            {/* Assigned to */}
            <div className='modal-label-and-input'>
              <label for="assigned_to" className='modal-label'>Assigned to</label>
              <input 
                type="text" 
                name="assignedTo" 
                id="assignedTo" 
            ...
            {/* Label */}
            <div className='modal-label-and-input'>
              <label for="label" className='modal-label'>Label</label>
              <input 
                type="text" 
                name="label" 
                id="label" 
